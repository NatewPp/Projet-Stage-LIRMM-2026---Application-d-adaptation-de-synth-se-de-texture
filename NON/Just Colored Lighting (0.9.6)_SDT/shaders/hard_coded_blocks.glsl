...
float emmissiveness=0.;
    ...
    {//hands vs vertex wrapper
        float c_id = (i == 0 )? float(heldItemId) : float(heldItemId2);
 ...
 light_color.rgb = 
	...
	//glowing item frames
		: (c_id == 20011) ? vec3(GLOW_FRAME_R,GLOW_FRAME_G,GLOW_FRAME_B) 
		 ...
		 :(c_id == 10074.0) ?   vec3(LIGHT_BLOCK_R, LIGHT_BLOCK_G, LIGHT_BLOCK_B) //utility creative light block  SOUL_TORCH_R SOUL_TORCH_G SOUL_TORCH_B SOUL_TORCH_R_HIGH SOUL_TORCH_G_HIGH SOUL_TORCH_B_HIGH
				
			 :(c_id == 10075.0) ? //copper torches
       ...
       // light_color.rgb = 
        :(c_id == 10113.0 ) ?  RED
        :(c_id == 10101.0 ) ?  RED_ORANGE
        :(c_id == 10102.0 ) ?  ORANGE
        :(c_id == 10103.0 ) ?  YELLOW
        :(c_id == 10104.0 ) ?  YELLOW_GREEN
        :(c_id == 10105.0 ) ?  GREEN
        :(c_id == 10106.0   ) ?  GREEN_CYAN
        :(c_id == 10107.0 ) ?  CYAN
        :(c_id == 10108.0 ) ?  BLUE_CYAN
        :(c_id == 10109.0 ) ?  BLUE
        :(c_id == 10110.0    ) ?  PURPLE
        :(c_id == 10111.0  ) ?  MAGENTA
        :(c_id == 10112.0  ) ?  RED_MAGENTA

        //## UN-SATURATED COLORS (half white)

        :(c_id == 10120.0  ) ? LIGHT_RED  
        :(c_id == 10121.0  ) ?  LIGHT_RED_ORANGE
        :(c_id == 10122.0 ) ?  LIGHT_ORANGE
        :(c_id == 10123.0 ) ?  LIGHT_YELLOW
        :(c_id == 10124.0 ) ?  LIGHT_YELLOW_GREEN
        :(c_id == 10125.0 ) ?  LIGHT_GREEN
        :(c_id == 10126.0 ) ?  LIGHT_GREEN_CYAN
        :(c_id == 10127.0 ) ?  LIGHT_CYAN
        :(c_id == 10128.0 ) ?  LIGHT_BLUE_CYAN
        :(c_id == 10129.0 ) ?  LIGHT_BLUE
        :(c_id == 10130.0 ) ?  LIGHT_PURPLE
        :(c_id == 10131.0 ) ?  LIGHT_MAGENTA
        :(c_id == 10132.0 ) ?  LIGHT_RED_MAGENTA

        //## DIM COLORS (not very bright)

        :(c_id == 10140.0 ) ?  DIM_RED
        :(c_id == 10141.0 ) ?  DIM_RED_ORANGE
        :(c_id == 10142.0 ) ?  DIM_ORANGE
        :(c_id == 10143.0 ) ?  DIM_YELLOW
        :(c_id == 10144.0 ) ?  DIM_YELLOW_GREEN
        :(c_id == 10145.0 ) ?  DIM_GREEN
        :(c_id == 10146.0 ) ?  DIM_GREEN_CYAN
        :(c_id == 10147.0 ) ?  DIM_CYAN
        :(c_id == 10148.0 ) ?  DIM_BLUE_CYAN
        :(c_id == 10149.0 ) ?  DIM_BLUE
        :(c_id == 10150.0 ) ?  DIM_PURPLE
        :(c_id == 10151.0 ) ?  DIM_MAGENTA
        :(c_id == 10152.0 ) ?  DIM_RED_MAGENTA


        :(c_id == 10160.0 ) ?  WHITE

        :(c_id == 10161.0 ) ?  DIM_WHITE
...
if(c_id>=10113.0 && c_id<=  10152.0) emmissiveness = 15.;//flag as light
					

//ipbr sss
 light_color.a = (c_id == 10080.0) ? .5 : light_color.a;
 
#if IS_HAND_CHECK_FROM_LIST == 1

//DEBUG, WOOL IS SET RED AND YELLOW IN BLOCK.PROPERTIES
    light_color= abs(c_id - 10113.)<.5? vec4(1.,0.,0.,1.):vec4(0.);//debug

   if(i == 0){ hand_color = light_color; }else{ hand_color2 = light_color;  }
